...
```text title="AI への指示"
国土数値情報ダウンロードサイトのポータル「https://nlftp.mlit.go.jp/ksj/」 からページを読み、2025年1月1日以降に更新されたデータをリストアップしてください。
...
(2) 日付の新しい順に並べてください。
(3) URL はページ内の相対リンクを「https://nlftp.mlit.go.jp/」から始まる絶対 URL に直してください。
